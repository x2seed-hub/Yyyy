...
local library = {
	...
	colors = {
		main = Color3.fromRGB(173,255,47),
...
local PepsiUi =
    ...
    {
        Name = "บังอร Hub | KaiTun Mobe",
        Theme = {Image = "rbxassetid://10509313657", Info = "Info", Background = {Asset = "rbxassetid://10509313657"}}
    }
)
local KaiTun = PepsiUi:CreateTab({Name = "Genaral"})
local KaiTun2 = KaiTun:CreateSection({Name = "Main", Side = "Left"})
KaiTun2:AddToggle(
    {Name = "Start KaiTun", Value = true, Callback = function(value)
            getgenv().LevelFarm = value
            StopBodyClip(getgenv().LevelFarm)
        end}
)
KaiTun2:AddToggle({Name = "White Screen",Value = true , Callback = function(v)
	_G.WhiteScreen = v
...
KaiTun2:AddToggle(
    {Name = "Fast Attack", Value = true, Callback = function(value)
                                            ...
                                            if
                                             ...
                                             then
                                                repeat
                                                    ...
                                                    v.Humanoid.WalkSpeed = 0
                                                    v.Head.CanCollide = false
                                                    TweenFarm(v.HumanoidRootPart.CFrame * CFrame.new(0, 35, 0))
                                                    game:GetService("VirtualUser"):CaptureController()
